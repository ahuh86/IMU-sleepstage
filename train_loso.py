...
def main():
    ...
    weighting.add_argument('--use-class-weight', action='store_true',
                           help='Weight loss by N/(4*class count), using training subjects only')
    weighting.add_argument('--use-sqrt-class-weight', action='store_true',
                           help='Weight loss by sqrt(N/(4*class count)), using training subjects only')
